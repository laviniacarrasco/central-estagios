...
<body class="min-h-screen bg-gray-50">
    ...
    <div class="sidebar fixed left-0 top-0 h-full w-16 flex flex-col items-center py-4 z-40">
        ...
        <!-- Logo FSA -->
<div class="mb-8 mt-2 flex items-center justify-center" style="width: 64px; height: 64px; padding: 4px;">
    <img
    ...
    <header class="fixed top-0 right-0 left-16 h-16 bg-white border-b border-gray-200 flex items-center px-8 z-30">
        ...
        <h1 class="text-xl font-bold text-gray-900"><?php echo htmlspecialchars($pageTitle); ?></h1>

        <!-- Avatar / Perfil -->
        <a href="profile.php"
           class="ml-auto flex items-center gap-3 px-4 py-2 border-2 border-gray-200 rounded-full hover:border-[#4A9FCA] hover:bg-gray-50 transition-all cursor-pointer"
           title="Ver Perfil">
