 ...
 * Espera que $userData, $corAtual, $certs, $layoutAtual e fmtData() ja existam.
...
<div style="margin-bottom:22px;">
    <div style="border-bottom:2px solid <?php echo $corAtual['primary']; ?>;padding-bottom:6px;margin-bottom:10px;">
        <span style="font-size:11px;font-weight:800;color:<?php echo $corAtual['primary']; ?>;text-transform:uppercase;letter-spacing:1.5px;">Resumo Profissional</span>
    </div>
...
<div style="margin-bottom:22px;">
    <div style="border-bottom:2px solid <?php echo $corAtual['primary']; ?>;padding-bottom:6px;margin-bottom:10px;">
        <span style="font-size:11px;font-weight:800;color:<?php echo $corAtual['primary']; ?>;text-transform:uppercase;letter-spacing:1.5px;">Historico Profissional</span>
    </div>
...
<div style="margin-bottom:22px;">
    <div style="border-bottom:2px solid <?php echo $corAtual['primary']; ?>;padding-bottom:6px;margin-bottom:10px;">
        <span style="font-size:11px;font-weight:800;color:<?php echo $corAtual['primary']; ?>;text-transform:uppercase;letter-spacing:1.5px;">Formacao Academica</span>
    </div>
        ...
        <table style="width:100%;border-collapse:collapse;">
            <tr>
                <td style="vertical-align:top;">
                    ...
                    <div style="font-size:12px;color:#555;"><?php echo htmlspecialchars($form['tipo']); ?> em <?php echo htmlspecialchars($form['curso']); ?></div>
                </td>
...
<div style="margin-bottom:22px;">
    <div style="border-bottom:2px solid <?php echo $corAtual['primary']; ?>;padding-bottom:6px;margin-bottom:10px;">
        <span style="font-size:11px;font-weight:800;color:<?php echo $corAtual['primary']; ?>;text-transform:uppercase;letter-spacing:1.5px;">Habilidades e Competencias</span>
    </div>
    <?php
...
<div style="margin-bottom:22px;">
    <div style="border-bottom:2px solid <?php echo $corAtual['primary']; ?>;padding-bottom:6px;margin-bottom:10px;">
        <span style="font-size:11px;font-weight:800;color:<?php echo $corAtual['primary']; ?>;text-transform:uppercase;letter-spacing:1.5px;">Idiomas</span>
    </div>
    <table style="width:100%;border-collapse:collapse;">
        <tr>
            ...
            <td style="padding:0 24px 0 0;vertical-align:top;">
                <div style="border-bottom:1px dashed #ddd;padding:6px 0;">
                    ...
                    <div style="font-size:10px;color:<?php echo $corAtual['secondary']; ?>;font-weight:700;text-transform:uppercase;letter-spacing:.3px;"><?php echo htmlspecialchars($idi['nivel']); ?></div>
                </div>
            </td>
            <?php endforeach; ?>
        </tr>
...
<div style="margin-bottom:20px;">
    <div style="border-bottom:2px solid <?php echo $corAtual['primary']; ?>;padding-bottom:6px;margin-bottom:10px;">
        <span style="font-size:11px;font-weight:800;color:<?php echo $corAtual['primary']; ?>;text-transform:uppercase;letter-spacing:1.5px;">Cursos Complementares</span>
    </div>
    <table style="width:100%;border-collapse:collapse;">
        <thead><tr style="border-bottom:1px solid #e5e7eb;">
            ...
            <th style="text-align:left;padding:6px 4px;font-size:10px;color:#999;font-weight:700;text-transform:uppercase;">Instituicao</th>
