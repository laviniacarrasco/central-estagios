...
<div class="p-8 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-label">Em Atividade — Na Área</div>
            </div>
        </div>
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-label">Em Atividade — Fora da Área</div>
            </div>
        </div>
        <div class="stat-card">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-8">
        ...
        <div class="panel-card panel-accent">
            ...
            <p class="panel-subtitle">Aberto apenas para referência — os cards acima já somam os dois</p>
            <div class="chart-box">
    ...
    <div class="panel-card panel-accent mb-8">
        <div class="panel-title"><i class="fas fa-graduation-cap"></i> Estágio Obrigatório por Curso</div>
    ...
    <tbody>
        ...
        <tr>
            <td colspan="6" class="text-center text-gray-400 italic py-6">
...
function onMselChange(checkbox) {
    atualizarLabelMsel(checkbox.closest('.msel'));
}
