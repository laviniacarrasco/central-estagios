...
$fsaCourses = [
    ...
    "Engenharia Mecânica", "Engenharia Elétrica", "Engenharia de Produção", "Engenharia Civil",
    "Administração", "Psicologia", "Arquitetura e Urbanismo", "Ciências Biológicas",
    "Direito", "Pedagogia", "Ciência da Computação", "Sistemas de Informação"
];
...
function normalize($str) {
    return strtolower(preg_replace('/[áàãâäéèêëíìîïóòõôöúùûüç]/', '', $str));
}
