...
/* =========================================================================
 * NOVO: IDIOMA DO CONTEUDO DO CURRICULO (Portugues / Ingles / Espanhol)
 * -------------------------------------------------------------------------
 * Nao mexe em nenhuma logica existente. Isso e apenas uma CAMADA DE TEXTO:
 * os arrays getNiveisIdioma() e a lista de tipos de formacao continuam
 * retornando os MESMOS valores internos de sempre (que sao os valores
 * salvos no <select>). Aqui so criamos "dicionarios" que traduzem esses
 * mesmos valores para o rotulo exibido ao usuario, dependendo do idioma
 * escolhido para o curriculo.
 * ========================================================================= */
function getIdiomasCVMap() {
    return [
        'pt' => ['label' => 'Portugu&ecirc;s', 'flag' => '🇧🇷'],
        'en' => ['label' => 'English',         'flag' => '🇺🇸'],
        'es' => ['label' => 'Espa&ntilde;ol',  'flag' => '🇪🇸'],
    ];
}

/* Traduz os valores de TIPOS_FORMACAO (usados no <select> de formacao)
   sem alterar os valores internos salvos no banco. */
function getTiposFormacaoLabels($idioma) {
    $mapas = [
        'pt' => ['Graduacao' => 'Bacharelado', 'Tecnico' => 'Técnico', 'Pos-Graduacao' => 'Pós-Graduação', 'MBA' => 'MBA', 'Mestrado' => 'Mestrado', 'Doutorado' => 'Doutorado'],
        'en' => ['Graduacao' => "Bachelor's Degree", 'Tecnico' => 'Technical Course', 'Pos-Graduacao' => 'Postgraduate', 'MBA' => 'MBA', 'Mestrado' => "Master's Degree", 'Doutorado' => 'Doctorate'],
        'es' => ['Graduacao' => 'Licenciatura', 'Tecnico' => 'Técnico', 'Pos-Graduacao' => 'Posgrado', 'MBA' => 'MBA', 'Mestrado' => 'Maestría', 'Doutorado' => 'Doctorado'],
    ];
    return $mapas[$idioma] ?? $mapas['pt'];
}

/* Traduz os valores de getNiveisIdioma() (usados no <select> de nivel de
   idioma falado) sem alterar os valores internos salvos no banco. */
function getNiveisIdiomaLabels($idioma) {
    $mapas = [
        'pt' => ['Basico' => 'Básico', 'Pre-intermediario' => 'Pré-intermediário', 'Intermediario' => 'Intermediário', 'Avancado' => 'Avançado', 'Proficiente' => 'Proficiente', 'Fluente' => 'Fluente', 'Nativo' => 'Nativo'],
        'en' => ['Basico' => 'Basic', 'Pre-intermediario' => 'Pre-Intermediate', 'Intermediario' => 'Intermediate', 'Avancado' => 'Advanced', 'Proficiente' => 'Proficient', 'Fluente' => 'Fluent', 'Nativo' => 'Native'],
        'es' => ['Basico' => 'Básico', 'Pre-intermediario' => 'Preintermedio', 'Intermediario' => 'Intermedio', 'Avancado' => 'Avanzado', 'Proficiente' => 'Competente', 'Fluente' => 'Fluido', 'Nativo' => 'Nativo'],
    ];
    return $mapas[$idioma] ?? $mapas['pt'];
}

/* Todos os textos fixos do CONTEUDO do curriculo (titulos de secao,
   placeholders, textos de "nenhum item", botoes de adicionar, labels de
   campos ao editar). Nada aqui muda a logica -- so o texto exibido. */
function getTextosCV($idioma) {
    $textos = [
        'pt' => [
            'titulo_resumo'        => 'Resumo Profissional',
            'titulo_experiencia'   => 'Hist&oacute;rico Profissional',
            'titulo_formacao'      => 'Forma&ccedil;&atilde;o Acad&ecirc;mica',
            'titulo_habilidades'   => 'Habilidades e Compet&ecirc;ncias',
            'titulo_idiomas'       => 'Idiomas',
            'titulo_certificados'  => 'Cursos Complementares',
            'subtitulo_cv'         => 'Curriculo Profissional',
            'placeholder_nome'     => 'Seu nome completo',
            'placeholder_email'    => 'seuemail@exemplo.com',
            'placeholder_telefone' => '(00) 00000-0000',
            'placeholder_cidade'   => 'Cidade, Estado',
            'placeholder_resumo'   => 'Escreva um breve resumo sobre voce, seus objetivos e diferenciais...',
            'placeholder_habilidades' => "Proatividade\nTrabalho em equipe\n...",
            'label_habilidade_linha' => 'Uma habilidade por linha',
            'sem_exp'              => 'Nenhuma experi&ecirc;ncia cadastrada ainda.',
            'sem_form'             => 'Nenhuma forma&ccedil;&atilde;o cadastrada ainda.',
            'sem_hab'              => 'Nenhuma habilidade cadastrada ainda.',
            'sem_idioma'           => 'Nenhum idioma cadastrado ainda.',
            'sem_cert'             => 'Nenhum certificado encontrado.',
            'btn_add_exp'          => 'Adicionar Experi&ecirc;ncia',
            'btn_add_form'         => 'Adicionar Forma&ccedil;&atilde;o',
            'btn_add_idioma'       => 'Adicionar Idioma',
            'badge_aprovado'       => 'Aprovado',
            'tag_experiencia'      => 'Experiencia',
            'tag_formacao'         => 'Formacao',
            'tag_idioma'           => 'Idioma',
            'btn_remover'          => 'Remover',
            'label_cargo'          => 'Cargo *',
            'placeholder_cargo'    => 'Ex: Estagi&aacute;rio de TI',
            'label_empresa'        => 'Empresa',
            'placeholder_empresa'  => 'Nome da empresa',
            'label_cidade_campo'   => 'Cidade',
            'placeholder_cidade_campo' => 'Cidade, Estado',
            'label_data_inicio'    => 'Data de In&iacute;cio',
            'label_data_fim'       => 'Data de T&eacute;rmino',
            'label_emprego_atual'  => 'Emprego atual',
            'label_descricao_ativ' => 'Descri&ccedil;&atilde;o das Atividades',
            'placeholder_descricao_ativ' => 'Descreva suas principais atividades...',
            'label_curso'          => 'Curso *',
            'placeholder_curso'    => 'Ex: Ci&ecirc;ncia de Dados',
            'label_instituicao'    => 'Institui&ccedil;&atilde;o',
            'placeholder_instituicao' => 'Nome da institui&ccedil;&atilde;o',
            'label_tipo'           => 'Tipo',
            'label_previsao_fim'   => 'Previs&atilde;o de Conclus&atilde;o',
            'label_cursando_atual' => 'Cursando atualmente',
            'label_idioma_campo'   => 'Idioma *',
            'placeholder_idioma'   => 'Ex: Ingl&ecirc;s',
            'label_nivel'          => 'N&iacute;vel',
            'tabela_curso'         => 'Curso',
            'tabela_instituicao'   => 'Institui&ccedil;&atilde;o',
            'tabela_carga'         => 'Carga',
        ],
        'en' => [
            'titulo_resumo'        => 'Professional Summary',
            'titulo_experiencia'   => 'Professional Experience',
            'titulo_formacao'      => 'Education',
            'titulo_habilidades'   => 'Skills',
            'titulo_idiomas'       => 'Languages',
            'titulo_certificados'  => 'Additional Courses',
            'subtitulo_cv'         => 'Professional Resume',
            'placeholder_nome'     => 'Your full name',
            'placeholder_email'    => 'youremail@example.com',
            'placeholder_telefone' => '(00) 00000-0000',
            'placeholder_cidade'   => 'City, State',
            'placeholder_resumo'   => 'Write a short summary about yourself, your goals and strengths...',
            'placeholder_habilidades' => "Proactivity\nTeamwork\n...",
            'label_habilidade_linha' => 'One skill per line',
            'sem_exp'              => 'No experience added yet.',
            'sem_form'             => 'No education added yet.',
            'sem_hab'              => 'No skills added yet.',
            'sem_idioma'           => 'No languages added yet.',
            'sem_cert'             => 'No certificates found.',
            'btn_add_exp'          => 'Add Experience',
            'btn_add_form'         => 'Add Education',
            'btn_add_idioma'       => 'Add Language',
            'badge_aprovado'       => 'Approved',
            'tag_experiencia'      => 'Experience',
            'tag_formacao'         => 'Education',
            'tag_idioma'           => 'Language',
            'btn_remover'          => 'Remove',
            'label_cargo'          => 'Job Title *',
            'placeholder_cargo'    => 'E.g.: IT Intern',
            'label_empresa'        => 'Company',
            'placeholder_empresa'  => 'Company name',
            'label_cidade_campo'   => 'City',
            'placeholder_cidade_campo' => 'City, State',
            'label_data_inicio'    => 'Start Date',
            'label_data_fim'       => 'End Date',
            'label_emprego_atual'  => 'Current job',
            'label_descricao_ativ' => 'Activity Description',
            'placeholder_descricao_ativ' => 'Describe your main activities...',
            'label_curso'          => 'Course *',
            'placeholder_curso'    => 'E.g.: Data Science',
            'label_instituicao'    => 'Institution',
            'placeholder_instituicao' => 'Institution name',
            'label_tipo'           => 'Type',
            'label_previsao_fim'   => 'Expected Completion',
            'label_cursando_atual' => 'Currently enrolled',
            'label_idioma_campo'   => 'Language *',
            'placeholder_idioma'   => 'E.g.: English',
            'label_nivel'          => 'Level',
            'tabela_curso'         => 'Course',
            'tabela_instituicao'   => 'Institution',
            'tabela_carga'         => 'Hours',
        ],
        'es' => [
            'titulo_resumo'        => 'Resumen Profesional',
            'titulo_experiencia'   => 'Historial Profesional',
            'titulo_formacao'      => 'Formaci&oacute;n Acad&eacute;mica',
            'titulo_habilidades'   => 'Habilidades y Competencias',
            'titulo_idiomas'       => 'Idiomas',
            'titulo_certificados'  => 'Cursos Complementarios',
            'subtitulo_cv'         => 'Curriculum Profesional',
            'placeholder_nome'     => 'Tu nombre completo',
            'placeholder_email'    => 'tuemail@ejemplo.com',
            'placeholder_telefone' => '(00) 00000-0000',
            'placeholder_cidade'   => 'Ciudad, Estado',
            'placeholder_resumo'   => 'Escribe un breve resumen sobre ti, tus objetivos y fortalezas...',
            'placeholder_habilidades' => "Proactividad\nTrabajo en equipo\n...",
            'label_habilidade_linha' => 'Una habilidad por l&iacute;nea',
            'sem_exp'              => 'A&uacute;n no se agreg&oacute; ninguna experiencia.',
            'sem_form'             => 'A&uacute;n no se agreg&oacute; ninguna formaci&oacute;n.',
            'sem_hab'              => 'A&uacute;n no se agreg&oacute; ninguna habilidad.',
            'sem_idioma'           => 'A&uacute;n no se agreg&oacute; ning&uacute;n idioma.',
            'sem_cert'             => 'No se encontraron certificados.',
            'btn_add_exp'          => 'Agregar Experiencia',
            'btn_add_form'         => 'Agregar Formaci&oacute;n',
            'btn_add_idioma'       => 'Agregar Idioma',
            'badge_aprovado'       => 'Aprobado',
            'tag_experiencia'      => 'Experiencia',
            'tag_formacao'         => 'Formaci&oacute;n',
            'tag_idioma'           => 'Idioma',
            'btn_remover'          => 'Eliminar',
            'label_cargo'          => 'Puesto *',
            'placeholder_cargo'    => 'Ej: Pasante de TI',
            'label_empresa'        => 'Empresa',
            'placeholder_empresa'  => 'Nombre de la empresa',
            'label_cidade_campo'   => 'Ciudad',
            'placeholder_cidade_campo' => 'Ciudad, Estado',
            'label_data_inicio'    => 'Fecha de Inicio',
            'label_data_fim'       => 'Fecha de Finalizaci&oacute;n',
            'label_emprego_atual'  => 'Empleo actual',
            'label_descricao_ativ' => 'Descripci&oacute;n de Actividades',
            'placeholder_descricao_ativ' => 'Describe tus principales actividades...',
            'label_curso'          => 'Curso *',
            'placeholder_curso'    => 'Ej: Ciencia de Datos',
            'label_instituicao'    => 'Instituci&oacute;n',
            'placeholder_instituicao' => 'Nombre de la instituci&oacute;n',
            'label_tipo'           => 'Tipo',
            'label_previsao_fim'   => 'Fecha Estimada de Finalizaci&oacute;n',
            'label_cursando_atual' => 'Cursando actualmente',
            'label_idioma_campo'   => 'Idioma *',
            'placeholder_idioma'   => 'Ej: Ingl&eacute;s',
            'label_nivel'          => 'Nivel',
            'tabela_curso'         => 'Curso',
            'tabela_instituicao'   => 'Instituci&oacute;n',
            'tabela_carga'         => 'Carga',
        ],
    ];
...
$defaultData = [
    ...
    'layout'       => 'classico',
    'corTema'      => 'azul-cinza',
    'idiomaCV'     => 'pt', // NOVO: idioma do conteudo do curriculo (pt | en | es)
    'exibirFoto'   => false,
    'fotoCV'       => null,
];
...
function montarUserDataDoPost($postArr, $dadosAtuais) {
    ...
    return [
        ...
        'idiomaCV'     => $dadosAtuais['idiomaCV']   ?? 'pt', // preservado (trocado por acao propria)
...
if (!array_key_exists($dadosSalvos['idiomaCV'], getIdiomasCVMap())) {
    $dadosSalvos['idiomaCV'] = 'pt';
}
...
/* NOVO: troca do idioma do conteudo do curriculo (pt | en | es).
   Segue exatamente o mesmo padrao de set_layout / set_cor. */
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'set_idioma_cv') {
    $idiomasValidos = array_keys(getIdiomasCVMap());
    $novoIdioma = $_POST['idiomaCV'] ?? 'pt';
    if (in_array($novoIdioma, $idiomasValidos)) {
        $dadosSalvos['idiomaCV'] = $novoIdioma;
        saveData('userCurriculum', $dadosSalvos, true);
    }
    header('Content-Type: application/json; charset=UTF-8');
    echo json_encode(['ok' => true]);
...
/* NOVO: idioma do conteudo do curriculo + textos/labels traduzidos.
   $niveisIdioma continua exatamente igual a antes (array simples de
   valores), usado normalmente onde ja era usado. */
$idiomasCVMap        = getIdiomasCVMap();
$idiomaCVAtual        = $userData['idiomaCV'] ?? 'pt';
$textos               = getTextosCV($idiomaCVAtual);
$tiposFormacaoLabels  = getTiposFormacaoLabels($idiomaCVAtual);
$niveisIdiomaLabels   = getNiveisIdiomaLabels($idiomaCVAtual);
...
/* NOVO: pills de selecao do idioma do curriculo (mesmo padrao visual
   dos demais seletores, nao interfere em nenhum estilo existente) */
.idioma-cv-pill{
    display:flex;align-items:center;gap:8px;
    border:2px solid #e5e7eb;border-radius:10px;
    padding:10px 16px;cursor:pointer;transition:all .15s;background:#fff;
    font-size:14px;font-weight:600;color:#374151;
}
.idioma-cv-pill:hover{ border-color:var(--cv-primary); }
.idioma-cv-pill.active{
    border-color:var(--cv-primary);
    background:#f8fafb;
    color:var(--cv-primary);
    box-shadow:0 0 0 3px rgba(0,0,0,.04);
}
.idioma-cv-pill .flag{ font-size:20px; line-height:1; }
...
<div class="p-8 max-w-6xl mx-auto">
    ...
    <div class="cv-section p-6 mb-6" style="height:auto;">
        ...
        <!-- ===== NOVO: Idioma do Curriculo (Portugues / Ingles / Espanhol) ===== -->
        <h3 class="text-sm font-bold text-gray-800 uppercase tracking-widest mb-3 mt-6">Idioma do Curr&iacute;culo</h3>
        <p class="text-xs text-gray-500 mb-3">Escolha em qual idioma os t&iacute;tulos e textos do curr&iacute;culo ser&atilde;o exibidos (na tela e no PDF).</p>
        <div class="flex gap-3 flex-wrap" id="idiomaCVSelector">
            <?php foreach ($idiomasCVMap as $key => $info): ?>
                <div class="idioma-cv-pill <?php echo $idiomaCVAtual === $key ? 'active' : ''; ?>"
                     data-idioma-cv-option="<?php echo $key; ?>"
                     onclick="selecionarIdiomaCV('<?php echo $key; ?>')">
    ...
    <form id="curriculumForm" method="POST" action="curriculum.php" accept-charset="UTF-8">
        ...
        <div class="cv-shell" id="cvShell" data-layout="<?php echo htmlspecialchars($layoutAtual); ?>" data-tema="<?php echo htmlspecialchars($userData['corTema']); ?>">
                ...
                <div class="relative z-10 flex flex-col md:flex-row md:items-center gap-6">
                    ...
                    <div class="flex-1">
                        <input type="text" name="nome" value="<?php echo htmlspecialchars($userData['nome']); ?>"
                            class="curriculum-field w-full bg-transparent text-2xl md:text-3xl font-extrabold placeholder-gray-400 focus:outline-none border-b-2 border-transparent focus:border-gray-300 pb-1" readonly placeholder="<?php echo htmlspecialchars($textos['placeholder_nome']); ?>">
                    </div>
                </div>
                <div class="relative z-10 flex flex-wrap gap-5 mt-6 justify-center md:justify-start">
                    <div class="cv-contact-pill">
                        ...
                        <input type="email" name="email" value="<?php echo htmlspecialchars($userData['email']); ?>"
                            class="curriculum-field bg-transparent placeholder-gray-400 focus:outline-none w-auto" readonly placeholder="<?php echo htmlspecialchars($textos['placeholder_email']); ?>" size="26">
                    </div>
                    <div class="cv-contact-pill">
                        ...
                        <input type="text" id="telefoneInput" name="telefone" value="<?php echo htmlspecialchars($userData['telefone']); ?>"
                            class="curriculum-field bg-transparent placeholder-gray-400 focus:outline-none w-auto" readonly placeholder="<?php echo htmlspecialchars($textos['placeholder_telefone']); ?>" maxlength="15" size="15">
                    </div>
                    <div class="cv-contact-pill">
                        ...
                        <input type="text" name="cidade" value="<?php echo htmlspecialchars($userData['cidade']); ?>"
                            class="curriculum-field bg-transparent placeholder-gray-400 focus:outline-none w-auto" readonly placeholder="<?php echo htmlspecialchars($textos['placeholder_cidade']); ?>" size="18">
                    </div>
                </div>
            </section>

            <section class="cv-section p-8" data-area="resumo">
                <div class="cv-section-title"><span><?php echo $textos['titulo_resumo']; ?></span></div>
                <textarea name="resumo" rows="4" class="curriculum-field w-full p-4 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 focus:outline-none focus:border-[var(--cv-primary)] min-h-[100px] leading-relaxed" readonly placeholder="<?php echo htmlspecialchars($textos['placeholder_resumo']); ?>"><?php echo htmlspecialchars($userData['resumo']); ?></textarea>
            </section>

            <section class="cv-section p-8" data-area="exp">
                <div class="cv-section-title">
                    <span><?php echo $textos['titulo_experiencia']; ?></span>
                    <button id="btnAddExp" type="button" onclick="addExperiencia()" style="display:none"
                        ...
                        <i class="fas fa-plus"></i> <?php echo $textos['btn_add_exp']; ?>
                    </button>
                </div>
                <div id="expViewContainer">
                    <?php if (empty($userData['experiencias'])): ?>
                        <p class="text-gray-400 text-sm italic"><?php echo $textos['sem_exp']; ?></p>
            ...
            <section class="cv-section p-8" data-area="form">
                <div class="cv-section-title">
                    <span><?php echo $textos['titulo_formacao']; ?></span>
                    <button id="btnAddForm" type="button" onclick="addFormacao()" style="display:none"
                        class="flex items-center gap-1 px-3 py-1.5 bg-[var(--cv-primary)] text-white text-xs font-bold rounded-lg hover:opacity-90 transition-colors normal-case tracking-normal">
                        <i class="fas fa-plus"></i> <?php echo $textos['btn_add_form']; ?>
                    </button>
                </div>
                <div id="formViewContainer">
                    <?php if (empty($userData['formacoes'])): ?>
                        <p class="text-gray-400 text-sm italic"><?php echo $textos['sem_form']; ?></p>
                    <?php else: foreach ($userData['formacoes'] as $form):
                        $ini       = fmtData($form['inicio']);
                        $fim       = fmtData($form['fim']);
                        $periodo   = $ini . ($fim ? ' - ' . $fim : '');
                        $tipoLabel = $tiposFormacaoLabels[$form['tipo']] ?? $form['tipo'];
                    ?>
                    <div class="cv-timeline-item">
                        <div class="flex justify-between items-start flex-wrap gap-2">
                            <div>
                                <p class="font-bold text-gray-900"><?php echo htmlspecialchars($form['instituicao']); ?></p>
                                <p class="text-sm text-gray-600 mt-0.5"><?php echo htmlspecialchars($tipoLabel); ?> em <?php echo htmlspecialchars($form['curso']); ?></p>
                            </div>
            ...
            <section class="cv-section p-8" data-area="skills">
                <div class="cv-section-title"><span><?php echo $textos['titulo_habilidades']; ?></span></div>
                <div id="skillsView" class="flex flex-wrap gap-2">
                    <?php if (empty($userData['habilidades'])): ?>
                        <p class="text-gray-400 text-sm italic opacity-80"><?php echo $textos['sem_hab']; ?></p>
                ...
                <div id="skillsEdit" class="hidden">
                    <p class="text-xs text-gray-400 mb-2"><?php echo $textos['label_habilidade_linha']; ?></p>
                    <textarea name="habilidades" rows="8" class="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 focus:outline-none focus:border-[var(--cv-primary)] text-sm" placeholder="<?php echo htmlspecialchars($textos['placeholder_habilidades']); ?>"><?php echo htmlspecialchars(implode("\n", $userData['habilidades'])); ?></textarea>
                </div>

                <div class="cv-section-title" style="margin-top:26px;">
                    <span><?php echo $textos['titulo_idiomas']; ?></span>
                    <button id="btnAddIdioma" type="button" onclick="addIdioma()" style="display:none"
                        class="flex items-center gap-1 px-3 py-1.5 bg-[var(--cv-primary)] text-white text-xs font-bold rounded-lg hover:opacity-90 transition-colors normal-case tracking-normal">
                        <i class="fas fa-plus"></i> <?php echo $textos['btn_add_idioma']; ?>
                    </button>
                </div>
                <div id="idiomasView">
                    <?php if (empty($userData['idiomas'])): ?>
                        <p class="text-gray-400 text-sm italic opacity-80"><?php echo $textos['sem_idioma']; ?></p>
                    <?php else: foreach ($userData['idiomas'] as $idi):
                        $nivelLabel = $niveisIdiomaLabels[$idi['nivel']] ?? $idi['nivel'];
                    ?>
                    <div class="cv-idioma-item">
                        <span class="cv-idioma-nome"><?php echo htmlspecialchars($idi['idioma']); ?></span>
                        <span class="cv-idioma-nivel"><?php echo htmlspecialchars($nivelLabel); ?></span>
                    </div>
                    <?php endforeach; endif; ?>
                </div>
            ...
            <section class="cv-section p-8" data-area="certs">
                <div class="cv-section-title"><span><?php echo $textos['titulo_certificados']; ?></span></div>
                <?php if (empty($certs)): ?>
                    <p class="text-gray-400 text-sm italic"><?php echo $textos['sem_cert']; ?></p>
                <?php else: ?>
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between gap-4 p-4 bg-gray-50 rounded-lg border border-gray-100">
                        ...
                        <div class="flex items-center gap-3 flex-shrink-0">
                            ...
                            <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200"><?php echo $textos['badge_aprovado']; ?></span>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
...
<?php if ($layoutAtual === 'moderno'): ?>
    <div style="display:flex;align-items:stretch;width:100%;">
        <div style="width:250px;flex:0 0 250px;background:<?php echo $corAtual['secondary']; ?>;padding:36px 24px;color:#fff;box-sizing:border-box;">
            ...
            <div style="text-align:center;font-size:10px;opacity:.85;margin-bottom:20px;"><?php echo $textos['subtitulo_cv']; ?></div>
            ...
            <div style="border-top:1px solid rgba(255,255,255,.3);padding-top:14px;margin-bottom:20px;">
                <div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;margin-bottom:10px;"><?php echo $textos['titulo_habilidades']; ?></div>
            ...
            <div style="border-top:1px solid rgba(255,255,255,.3);padding-top:14px;">
                <div style="font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;margin-bottom:10px;"><?php echo $textos['titulo_idiomas']; ?></div>
                <?php foreach ($userData['idiomas'] as $idi):
                    $nivelLabelSb = $niveisIdiomaLabels[$idi['nivel']] ?? $idi['nivel'];
                ?>
                    <div style="font-size:11px;padding:4px 0;">
                        <div style="font-weight:700;"><?php echo htmlspecialchars($idi['idioma']); ?></div>
                        <div style="opacity:.85;font-size:10px;"><?php echo htmlspecialchars($nivelLabelSb); ?></div>
                    </div>
                <?php endforeach; ?>
            </div>
            <?php endif; ?>
        ...
        <div style="flex:1;min-width:0;padding:36px 40px;box-sizing:border-box;">
            <?php include __DIR__ . '/pdf-section.php'; ?>
        </div>
    </div>
...
<?php else: ?>
    <div style="background:<?php echo $corAtual['primary']; ?>;padding:34px 52px 26px;display:flex;align-items:center;gap:20px;color:#fff;">
        ...
        <div>
            ...
            <div style="font-size:12px;color:rgba(255,255,255,.85);margin-bottom:6px;"><?php echo $textos['subtitulo_cv']; ?></div>
...
const TIPOS_FORMACAO_VALUES = ['Graduacao','Tecnico','Pos-Graduacao','MBA','Mestrado','Doutorado'];
const NIVEIS_IDIOMA_VALUES = <?php echo json_encode($niveisIdioma, JSON_UNESCAPED_UNICODE); ?>;
/* NOVO: labels traduzidos (o VALOR salvo continua o mesmo, so o texto exibido muda) */
const TIPOS_FORMACAO_LABELS = <?php echo json_encode($tiposFormacaoLabels, JSON_UNESCAPED_UNICODE); ?>;
const NIVEIS_IDIOMA_LABELS  = <?php echo json_encode($niveisIdiomaLabels, JSON_UNESCAPED_UNICODE); ?>;
const TEXTOS_CV = <?php echo json_encode($textos, JSON_UNESCAPED_UNICODE); ?>;
...
/* NOVO: troca do idioma do CONTEUDO do curriculo (pt | en | es).
   Recarrega a pagina para que o PHP renderize tudo novamente no idioma
   escolhido -- segue o mesmo padrao de selecionarLayout/selecionarCor. */
function selecionarIdiomaCV(idioma){
    document.querySelectorAll('[data-idioma-cv-option]').forEach(el => {
        el.classList.toggle('active', el.dataset.idiomaCvOption === idioma);
    });
    const fd = new FormData();
    fd.append('action', 'set_idioma_cv');
    fd.append('idiomaCV', idioma);
    fetch('curriculum.php', {method:'POST', body:fd}).then(() => {
        mostrarToast('Idioma do curr\u00edculo alterado -- atualizando...');
        setTimeout(() => location.reload(), 400);
    });
}
...
function buildExpHTML(idx,data={}){
    ...
    <div class="exp-entry bg-gray-50 border-2 border-gray-100 rounded-2xl p-5" data-idx="${idx}">
        <div class="flex justify-between items-center mb-4">
            <span class="text-xs font-bold text-[var(--cv-primary)] uppercase tracking-wide">${TEXTOS_CV.tag_experiencia}</span>
            <button type="button" onclick="removeExp(this)" class="remove-exp-btn text-xs text-red-400 hover:text-red-600 font-semibold px-2 py-1 rounded-lg hover:bg-red-50 transition-colors"><i class="fas fa-trash-alt"></i> ${TEXTOS_CV.btn_remover}</button>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_cargo}</label>
                <input type="text" name="exp_${idx}_cargo" value="${escHtml(data.cargo||'')}" placeholder="${TEXTOS_CV.placeholder_cargo}" class="w-full p-3 bg-white border border-gray-200 rounded-xl text-gray-700 focus:outline-none focus:border-[var(--cv-primary)]"></div>
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_empresa}</label>
                <input type="text" name="exp_${idx}_empresa" value="${escHtml(data.empresa||'')}" placeholder="${TEXTOS_CV.placeholder_empresa}" class="w-full p-3 bg-white border border-gray-200 rounded-xl text-gray-700 focus:outline-none focus:border-[var(--cv-primary)]"></div>
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_cidade_campo}</label>
                <input type="text" name="exp_${idx}_cidade" value="${escHtml(data.cidade||'')}" placeholder="${TEXTOS_CV.placeholder_cidade_campo}" class="w-full p-3 bg-white border border-gray-200 rounded-xl text-gray-700 focus:outline-none focus:border-[var(--cv-primary)]"></div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 items-end">
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_data_inicio}</label>
                <div class="cdp-wrapper"><input type="hidden" name="exp_${idx}_inicio" id="dp_exp_${idx}_inicio" value="${escHtml(data.inicio||'')}"></div></div>
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_data_fim}</label>
            ...
            <div class="flex items-center gap-2 pb-1">
                ...
                <label for="exp_${idx}_atual_cb" class="text-sm text-gray-600 font-medium cursor-pointer">${TEXTOS_CV.label_emprego_atual}</label>
            </div>
        </div>
        <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_descricao_ativ}</label>
            <textarea name="exp_${idx}_descricao" rows="3" placeholder="${TEXTOS_CV.placeholder_descricao_ativ}" class="w-full p-3 bg-white border border-gray-200 rounded-xl text-gray-700 focus:outline-none focus:border-[var(--cv-primary)]">${escHtml(data.descricao||'')}</textarea></div>
    </div>`;
}

function buildFormHTML(idx,data={}){
    const isAtual=(data.atual||'0')==='1';
    const tipoOpts=TIPOS_FORMACAO_VALUES.map(v=>`<option value="${v}" ${(data.tipo||'')===v?'selected':''}>${TIPOS_FORMACAO_LABELS[v]||v}</option>`).join('');
    return `
    <div class="form-entry bg-gray-50 border-2 border-gray-100 rounded-2xl p-5" data-idx="${idx}">
        <div class="flex justify-between items-center mb-4">
            <span class="text-xs font-bold text-[var(--cv-primary)] uppercase tracking-wide">${TEXTOS_CV.tag_formacao}</span>
            <button type="button" onclick="removeForm(this)" class="remove-form-btn text-xs text-red-400 hover:text-red-600 font-semibold px-2 py-1 rounded-lg hover:bg-red-50 transition-colors"><i class="fas fa-trash-alt"></i> ${TEXTOS_CV.btn_remover}</button>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_curso}</label>
                <input type="text" name="form_${idx}_curso" value="${escHtml(data.curso||'')}" placeholder="${TEXTOS_CV.placeholder_curso}" class="w-full p-3 bg-white border border-gray-200 rounded-xl text-gray-700 focus:outline-none focus:border-[var(--cv-primary)]"></div>
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_instituicao}</label>
                <input type="text" name="form_${idx}_instituicao" value="${escHtml(data.instituicao||'')}" placeholder="${TEXTOS_CV.placeholder_instituicao}" class="w-full p-3 bg-white border border-gray-200 rounded-xl text-gray-700 focus:outline-none focus:border-[var(--cv-primary)]"></div>
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_tipo}</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
            ...
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_previsao_fim}</label>
            ...
            <div class="flex items-center gap-2 pb-1">
                ...
                <label for="form_${idx}_atual_cb" class="text-sm text-gray-600 font-medium cursor-pointer">${TEXTOS_CV.label_cursando_atual}</label>
            </div>
        </div>
    </div>`;
}
...
function buildIdiomaHTML(idx,data={}){
    const nivelOpts=NIVEIS_IDIOMA_VALUES.map(v=>`<option value="${v}" ${(data.nivel||'')===v?'selected':''}>${NIVEIS_IDIOMA_LABELS[v]||v}</option>`).join('');
    return `
    <div class="idioma-entry bg-gray-50 border-2 border-gray-100 rounded-2xl p-4" data-idx="${idx}">
        <div class="flex justify-between items-center mb-3">
            <span class="text-xs font-bold text-[var(--cv-primary)] uppercase tracking-wide">${TEXTOS_CV.tag_idioma}</span>
            <button type="button" onclick="removeIdioma(this)" class="remove-idioma-btn text-xs text-red-400 hover:text-red-600 font-semibold px-2 py-1 rounded-lg hover:bg-red-50 transition-colors"><i class="fas fa-trash-alt"></i> ${TEXTOS_CV.btn_remover}</button>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_idioma_campo}</label>
                <input type="text" name="idioma_${idx}_idioma" value="${escHtml(data.idioma||'')}" placeholder="${TEXTOS_CV.placeholder_idioma}" class="w-full p-3 bg-white border border-gray-200 rounded-xl text-gray-700 focus:outline-none focus:border-[var(--cv-primary)]"></div>
            <div><label class="block text-xs font-semibold text-gray-400 mb-1 uppercase">${TEXTOS_CV.label_nivel}</label>
